...
开发者出于让文件包含所使用的参数看起来更不显眼、防止任意文件读取、或防止攻击者通过 LFI + UFU 来 getshell等原因往往会固定扩展名
...
在 php < 5.3.4 & magic_quotes_gpc = Off 时可用（由于我的环境是 PHP7 所以就不演示了～）
